        ...
        <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="nama_obat" id="inputNamaObat" placeholder="Nama" value="<?php echo $nama ?>">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input type="number" class="form-control" name="harga" id="inputHarga" placeholder="No HP" value="<?php echo $harga ?>">
                </div>
                <div class="col-12">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                href="index.php?page=obat&aksi=hapus&id=<?php echo $data['id'] ?>">Hapus</a>
                            </td>
                        </tr>
                    <?php
                    }
